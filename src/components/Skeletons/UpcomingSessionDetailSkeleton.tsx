...
const UpcomingSessionDetailSkeleton = () => {
	return (
		<div className="bg-white p-5 rounded-3xl shadow-3xl dark:bg-dark-lightBackground dark:border dark:border-slate-800 ">
			<div className="bg-purple rounded-2xl px-5 py-2 text-xl font-bold text-white flex justify-center dark:bg-dark-primary">
				<Skeleton className="h-5 largePhone:w-[250px] w-[100px]" />
			</div>
			<div className="flex items-center gap-4 ">
				<div className="flex flex-col gap-y-6 p-4 border-purple border-2 rounded-3xl my-2 dark:border-dark-primary">
					<div
          ...
          items-center largePhone:flex-row flex-col justify-center gap-y-2 dark:bg-dark-lightPrimary"
					>
