...
const UpcomingSession = ({
	...
	return (
		<div
			className="bg-white dark:bg-slate-950 dark:border dark:border-slate-800 p-3 largePhone:w-[380px]  rounded-3xl flex items-center gap-2  largePhone:justify-between move-button cursor-pointer m-4 
